			...
			if(($error=$pop3->Statistics($messages,$size))=="")
			{
				...
				if(GetType($result)=="array")
				{
					...
					if(GetType($result)=="array")
					{
						...
						for(Reset($result),$message=0;$message<count($result);
						    Next($result),$message++)
						...
						{   
							...
							if(($error=$pop3->RetrieveMessage(4,$headers,$body,4))=="")
							{
								var_dump([$headers],[]);
								die;
